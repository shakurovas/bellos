...
$APPLICATION->SetTitle(Loc::GetMessage('PROMOTIONS_PAGE_TITLE'));
?><main class="page" id="brands"> <section class="promotions">
<div class="container">
	...
	array(
		...
		"USE_RSS" => "N",
		"USE_SEARCH" => "N",
		"COMPONENT_TEMPLATE" => "actions_page",
	...
	<?php if (!$USER->IsAuthorized()):?>
		<div class="stock__block-bottom">
			...
			<div class="main__wrap" id="main__wrapthird">
				<h3 id="footer-title" class="main__subtitle"><?=Loc::GetMessage('REQUEST_FOR_A_PERSONAL_ACCOUNT');?></h3>
