        ...
        <nav class="header__menu menu nav">
          ...
          <ul class="menu__list <?php echo ($USER->IsAuthorized()) ? 'menu-mobile-items' : 'menu-items-top'?>" <?php echo ($USER->IsAuthorized()) ? 'style="grid-gap: 20px 3px;"' : '';?>>
            ...
            <li <?php if (!$USER->IsAuthorized()) echo 'id="modalBtn"';?> class="menu__item menu__item__icon <?php echo (!$USER->IsAuthorized()) ? 'modal-btn-gear' : 'gear-button-entrance';?>" <?php if (!$USER->IsAuthorized()) echo 'style="margin-right: -64px;"';?>>
              <a <?php if ($USER->IsAuthorized()) echo 'href="/personal_data/"';?>>
            ...
            <?php if ($USER->IsAuthorized()):?>
              <li class="menu__item menu__item__icon menu__item-right user-name-logined"><a href="/personal_data/"><?=mb_strtoupper(CUser::GetFullName());?></a></li>
            <?php endif;?>

            <?php if (!$USER->IsAuthorized()):?>
              <li class="mobile-entrance-item entrance-phrase-mobile">
                <?=GetMessage('ENTRANCE_TO_PERSONAL_ACCOUNT');?>
              </li>
            <?php endif;?>
           
            </ul>
          <ul class="menu__list-new">
            <li class="menu__item menu__item__icon whatsapp-gear">
              <a href="/404.php">
              <div class="main__img__block">
              <img class="main__img-first rot" src="<?=SITE_TEMPLATE_PATH;?>/images/icons/spinner.svg" alt="">
              <img class="main__img-second" src="<?=SITE_TEMPLATE_PATH;?>/images/icons/Whatsapp.svg" alt="">
            ...
            <li class="menu__item menu__item__icon telegram-gear"><a href="/404.php"><div class="main__img__block">
              <img class="main__img-first rot" src="<?=SITE_TEMPLATE_PATH;?>/images/icons/spinner.svg" alt="">
              <img class="main__img-second main__img-custom" src="<?=SITE_TEMPLATE_PATH;?>/images/icons/airplane.svg" alt="">
            </div></a>
          </li>
            <li class="menu__item-text"><?=GetMessage('ENTRANCE_TO_PERSONAL_ACCOUNT');?></li>
            <li id="modalBtn" class="menu__item menu__item-user"><a><div class="main__img__block">
              <img class="main__img-first rot" src="<?=SITE_TEMPLATE_PATH;?>/images/icons/spinner.svg" alt="">
              <img class="main__img-second" src="<?=SITE_TEMPLATE_PATH;?>/images/icons/user.svg" alt="">
            </div></a></li>
            <li class="menu__item menu__item__icon menu__item-right menu__item-entrance"><?=GetMessage('ENTRANCE_TO_PERSONAL_ACCOUNT');?></li>
          </ul>
          <?php if ($USER->IsAuthorized()):?>
        ...
        <div class="modal__header">
          ...
          <div class="modal__wrap">
            ...
            <form class="modal__form" name="request" id="request_form">
              ...
              <p class="modal__button modal__button__text" id="application-processing" onclick=sendForm()><?=GetMessage('LEAVE_A_REQUEST');?></p>
            </form>
          </div>
        </div>
      </div>
        ...
        <div class="modal__header">
          ...
          <div class="modal__wrap">
            ...
            <form class="modal__form" name='request'>
              <p class="modal__text"><?=GetMessage('NAME');?></p>
              <input class="modal__input modal__input__name" id="name_account_request" type="text" name="name">
              <p class="modal__text"><?=GetMessage('NUMBER');?></p>
              <input class="modal__input modal__input__pass" id="phone_account_request" type="tel">
              <p class="modal__button modal__button__text" id="application-processing2"><?=GetMessage('LEAVE_A_REQUEST');?></p>
            </form>
          </div>
        </div>
      </div>
        ...
        <div class="modal__header">
          ...
          <div class="modal__wrap">
            ...
            <form class="modal__form">
              ...
              <input class="modal__input modal__input__name" id="amount-input" type="number" name="name">
