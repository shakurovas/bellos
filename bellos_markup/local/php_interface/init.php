<?php
AddEventHandler("main", "OnAfterUserLogin", Array("AfterUserLoginClass", "OnAfterUserLoginHandler"));

class AfterUserLoginClass
{
    // creating handler for event "OnAfterUserLogin"
...
// not to show categories in search results (only elements)
...
class SearchHandlers
{
   function BeforeIndexHandler($arFields)
   {
      ...
      {
         if(array_key_exists("BODY", $arFields) && substr($arFields["ITEM_ID"], 0, 1) != "S") // only for elements
         {
            $arFields["BODY"] = "";
         }

         if (substr($arFields["ITEM_ID"], 0, 1) == "S") // only for sections
         {
            $arFields['TITLE'] = "";
            $arFields["BODY"] = "";
            $arFields['TAGS'] = "";
...
class MyClassSearch
{
   // creating handler for event "BeforeIndex"
   function BeforeIndexHandler($arFields)
   {
